...
plot(dt_sub$Tstamp,dt_sub$Sub_metering_1,type="l",xlab="",ylab="Energy sub metering")
lines(dt_sub$Tstamp,dt_sub$Sub_metering_2,col="red")
lines(dt_sub$Tstamp,dt_sub$Sub_metering_3,col="blue")
legend("topright",legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),box.lty=0,lty=1,col=c("black","red","blue"))
